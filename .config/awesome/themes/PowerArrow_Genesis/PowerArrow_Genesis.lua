...
theme.taglist_font                              = "SFMono Nerd Font SemiBold 8"
theme.fg_normal                                 = "#ffffff"
theme.primarycolor                              = "#A43A28"
theme.secondarycolor                            = "#0D5C63"
theme.fg_focus                                  = "#ffffff"
theme.fg_urgent                                 = "#b74822"
theme.bg_normal                                 = "#282a36"
theme.bg_focus                                  = "#A43A28"
theme.bg_urgent                                 = "#3F3F3F"
theme.taglist_fg_focus                          = "#ffffff"
theme.tasklist_bg_focus                         = "#A43A28"
theme.tasklist_fg_focus                         = "#ffffff"
------------ BORDER ------------
theme.border_width                              = 2
theme.border_normal                             = "#282a36"
theme.border_focus                              = "#0D5C63"
theme.border_marked                             = "#A43A28"
------------ Titlebar ------------
    ...
    s.mywibox:setup {
        ...
        { -- Right widgets
            ...
            wibox.container.background(wibox.container.margin(wibox.widget { mpdicon, theme.mpd.widget,
                layout = wibox.layout.align.horizontal }, 3, 6), "#49A078"),
            arrow("#49A078", "#3A7E5E"),
