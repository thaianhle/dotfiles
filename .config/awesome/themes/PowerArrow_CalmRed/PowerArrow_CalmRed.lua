...
theme.font                                      = "SFMono Nerd Font Regular 8"
theme.taglist_font                              = "SFMono Nerd Font SemiBold 8"
theme.fg_normal                                 = "#ffffff"
theme.primarycolor                              = "#660014"
theme.secondarycolor                            = "#4F000B"
theme.fg_focus                                  = "#ffffff"
theme.fg_urgent                                 = "#b74822"
theme.bg_normal                                 = "#282a36"
theme.bg_focus                                  = "#841C26"
theme.bg_urgent                                 = "#3F3F3F"
theme.taglist_fg_focus                          = "#ffffff"
theme.tasklist_bg_focus                         = "#000000"
theme.tasklist_fg_focus                         = "#660014"
------------ BORDER ------------
theme.border_width                              = 4
theme.border_normal                             = "#282a36"
theme.border_focus                              = "#4F000B"
theme.border_marked                             = "#660014"
------------ Titlebar ------------
    ...
    s.mywibox:setup {
        ...
        { -- Right widgets
            ...
            wibox.container.background(wibox.container.margin(wibox.widget { mpdicon, theme.mpd.widget,
                layout = wibox.layout.align.horizontal }, 3, 6), theme.secondarycolor),
            ...
            wibox.container.background(wibox.container.margin(wibox.widget { volicon, theme.volume.widget,
                layout = wibox.layout.align.horizontal }, 2, 3), theme.primarycolor),
            ...
            wibox.container.background(wibox.container.margin(wibox.widget { baticon, bat.widget,
                layout = wibox.layout.align.horizontal }, 3, 3), theme.secondarycolor),
            arrow(theme.secondarycolor, theme.primarycolor),
